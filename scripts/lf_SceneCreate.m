% lf_SceneCreate.m
% 
% Load rendered EXR light group files from iset3d-tiny/local 
% and combine them into an ISET scene for camera simulation.
% 
% Modified from s_hsSceneCreate in ISETHDRSENSOR.
% Change: separate LPD and SPD scenes
% 
% Last updated: Ayush Jamdar, 2025
