...
% Camera Params
cam_speed = 22.22; % meters per second;
...
for ii = 1:numel(recipes)
    ...
    for kk = 1:Nframes
        ...
        piWrite(thisR_spd, 'remoterender', true);
        piWrite(thisR_lpd, 'remoterender', true);
    ...
    if ~isempty(getpref('ISETDocker','remoteHost'))
        ...
        thisD.upload(outputDir, remoteSceneDir,{'renderings',[currName,'.mat']});
